...
__all__ = ["Shapelet2TransformRegressor"]
...
from tsml_eval.estimators.regression.transformations.shapelet2_transform import (
    RandomShapelet2Transform,
)


class Shapelet2TransformRegressor(BaseRegressor):
    """A shapelet transform classifier (STC).
    ...
    def __init__(
        ...
        super(Shapelet2TransformRegressor, self).__init__()
    ...
    def _fit(self, X, y):
        ...
        self._transformer = RandomShapelet2Transform(
